  ...
  return (
    <div className="space-y-12">
      <section className="rounded-xl border border-slate-800 bg-gradient-to-r from-blue-900/30 to-slate-900 p-10">
        ...
        <p className="mt-4 max-w-2xl text-slate-300">A multi-tenant B2B SaaS platform for SOC2, HIPAA, PCI-DSS, ISO27001, GDPR, and NIST readiness with continuous automated monitoring and integration-based evidence sync and auditor-ready reporting.</p>
